  ...
  <div class="registerBody">
    <b-form>
      ...
      <b-form-group label="Amount:">
        <CurrencyInput v-model="mov_register.value" />
      </b-form-group>
      <b-form-invalid-feedback
        v-if="mov_register.value !== null"
        :state="val_amount"
      >Your value must be between 0.01 and 5000.00 €</b-form-invalid-feedback>
      ...
      <b-form-invalid-feedback
        v-if="mov_register.iban !== null"
        :state="val_iban"
      >IBAN should be TWO capital letters and 23 numbers</b-form-invalid-feedback>
      ...
      <b-form-invalid-feedback
        v-if="mov_register.mb_entity_code !== null"
        :state="val_mb_entity"
      >MB Reference consists in 5 numbers</b-form-invalid-feedback>
      ...
      <b-form-invalid-feedback
        v-if="mov_register.mb_payment_reference !== null"
      ...
      <b-form-invalid-feedback
        v-if="mov_register.email !== null"
        :state="val_email"
      >It has to be a valid e-mail and exist in our database.</b-form-invalid-feedback>
...
export default {
  ...
  methods: {
    ...
    getWallet() {
      axios.get("api/user/wallet").then(response => {
        ...
        this.mov_register.start_balance = parseFloat(
    ...
    saveExpense() {
      if (this.canRegister()) {
        ...
        if (this.mov_register.type == "i") {
          ...
          axios
            .get("api/user/wallet/" + this.mov_register.email)
            .then(response => {
              if (response.data == "") {
                ...
                console.log(
                  "movement to save :",
                  JSON.parse(JSON.stringify(this.mov_register))
                );
                axios
                  .post("api/movements/registerInternal", this.mov_register)
                  .then(response => {
  ...
  computed: {
    val_amount() {
      if (!this.mov_register.value) return false;
    ...
    val_email() {
      if (this.mov_register.email == null) return true;
