...
Route::middleware(['auth:api', 'admin:api'])->get('bankbalance', 'ChartControllerAPI@bank'); //only for admin
...
Route::middleware('auth:api')->put('user/movements/{id}', 'MovementControllerAPI@update'); //only the user can access his movements
/*
|
|--------------------------------------------------------------------------
| DELETEs
